...
class ApplicationDiffblueTest {
    ...
    void testRun() {
        ...
        //       at hyperskill.chucknorris.Application.requestOperation(Application.java:78)
        ...
        //       at hyperskill.chucknorris.Application.run(Application.java:37)
        //   com.diffblue.cover.agent.UnboundedLoopException: Cover agent detected a potentially unbounded loop executing at hyperskill.chucknorris.Application#requestOperation:78
        //       at hyperskill.chucknorris.Application.requestOperation(Application.java:78)
        //       at java.base/java.util.stream.StreamSpliterators$InfiniteSupplyingSpliterator$OfRef.tryAdvance(StreamSpliterators.java:1358)
        //       at java.base/java.util.stream.ReferencePipeline.forEachWithCancel(ReferencePipeline.java:129)
        //       at java.base/java.util.stream.AbstractPipeline.copyIntoWithCancel(AbstractPipeline.java:527)
