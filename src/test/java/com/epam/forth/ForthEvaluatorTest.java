...
public class ForthEvaluatorTest {
    ...
    private final ForthEvaluator forthEvaluator = new ForthEvaluator();

    @Test
    @DisplayName("Test numbers are just pushed onto the stack")
    ...
    @Test
    @DisplayName("Test two numbers can be added")
    ...
    @Test
    @DisplayName("Test error if addition attempted with nothing on the stack")
    ...
    public void testUserDefinedOperatorsCanConsistOfBuiltInOperators() {
        assertEquals(
                List.of(1, 1, 1),
                forthEvaluator.evaluateProgram(List.of(": dup-twice dup dup ;", "1 dup-twice")));
    }
    ...
    public void testUserDefinedOperatorsAreEvaluatedInTheCorrectOrder() {
        assertEquals(
                List.of(1, 2, 3),
                forthEvaluator.evaluateProgram(List.of(": countup 1 2 3 ;", "countup")));
    }
    ...
    public void testCanRedefineAUserDefinedOperator() {
        assertEquals(
                List.of(1, 1, 1),
                forthEvaluator.evaluateProgram(List.of(": foo dup ;", ": foo dup dup ;", "1 foo")));
    }
    ...
    public void testCanOverrideBuiltInWordOperators() {
        assertEquals(
                List.of(1, 1),
                forthEvaluator.evaluateProgram(List.of(": swap dup ;", "1 swap")));
    }
    ...
    public void testCanOverrideBuiltInArithmeticOperators() {
        assertEquals(
                ...
                forthEvaluator.evaluateProgram(List.of(": + * ;", "3 4 +")));
    }
    ...
    public void testCanUseDifferentWordsWithTheSameName() {
        assertEquals(
                List.of(5, 6),
                forthEvaluator.evaluateProgram(List.of(": foo 5 ;", ": bar foo ;", ": foo 6 ;", "bar foo")));
    }
    ...
    public void testCanDefineWordThatUsesWordWithTheSameName() {
        assertEquals(
                ...
                forthEvaluator.evaluateProgram(List.of(": foo 10 ;", ": foo foo 1 + ;", "foo")));
    }
    ...
    public void testUserDefinedWordsAreCaseInsensitive() {
        assertEquals(
                List.of(1, 1, 1, 1),
                forthEvaluator.evaluateProgram(List.of(": foo dup ;", "1 FOO Foo foo")));
    }
    ...
    public void testDefinitionsAreCaseInsensitive() {
        assertEquals(
                List.of(1, 1, 1, 1),
                forthEvaluator.evaluateProgram(List.of(": SWAP DUP Dup dup ;", "1 swap")));
    }
}
